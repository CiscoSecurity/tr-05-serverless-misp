...
def misp_client():
    with patch.multiple(
        "pymisp.PyMISP",
        recommended_pymisp_version=MagicMock(return_value={"version": "2.4.125"}),
...
def misp_client_error():
    with patch("requests.Session.send") as patch_request:
        patch_request.return_value = mock_api_response(status_code=500, text="internal_error")
        yield patch_request
...
def misp_internal_expected_payload(route):
    return {
        "errors": [
            {
                "code": "unknown",
                "message": "Unexpected response from MISP: Unable to connect "
                "to MISP (https://1.2.3.4). Please make sure the API key "
        ...
        "data": {
                ...
                "docs": [
                    {
                        ...
                        "source": "MISP",
                        "type": "judgement",
                        "source_uri": ("https://1.2.3.4/events/view/" "542e4c9c-cadc-4f8f-bb11-6d13950d210b"),
                    }
                ],
            },
            "sightings": {
            ...
            "indicators": {
                ...
                "docs": [
                    {
                        "confidence": "High",
                        "id": "transient:indicator-" "542e4c9c-cadc-4f8f-bb11-6d13950d210b",
                        "valid_time": {
                            "end_time": "2014-10-02T00:00:00Z",
                            "start_time": "2014-10-02T00:00:00Z",
                        },
                ...
                "docs": [
                    {
                        ...
                        "schema_version": "1.1.5",
                        "target_ref": "transient:indicator-" "542e4c9c-cadc-4f8f-bb11-6d13950d210b",
                        "type": "relationship",
                    },
                    {
...
@fixture(scope="module")
def success_enrich_expected_payload(route, success_deliberate_body, success_observe_body, success_refer_body):
