...
CTIM_DEFAULTS = {"schema_version": "1.1.5"}
...
RELATIONSHIP_DEFAULTS = {**CTIM_DEFAULTS, "type": RELATIONSHIP}
...
class Mapping:
    ...
    def _source_uri(self, event):
        return current_app.config["SOURCE_URI"].format(host=self.host, uuid=event["uuid"])
